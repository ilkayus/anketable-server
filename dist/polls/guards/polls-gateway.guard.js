...
const websocket_exeptions_1 = require("../../exeptions/websocket-exeptions");
...
let GatewayAdminGuard = GatewayAdminGuard_1 = class GatewayAdminGuard {
    ...
    async canActivate(context) {
        ...
        if (!token) {
            ...
            throw new websocket_exeptions_1.WsUnauthorizedException('No token provided');
        }
        try {
            ...
            if (sub !== poll.adminID) {
                throw new websocket_exeptions_1.WsUnauthorizedException('Admin privileges required');
            }
            return true;
        }
        catch (_a) {
