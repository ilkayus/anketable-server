...
class CreatePollDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { topic: { required: true, type: () => String, minLength: 1, maxLength: 100 }, votesPerVoter: { required: true, type: () => Number, minimum: 1, maximum: 5 }, name: { required: true, type: () => String, minLength: 1, maxLength: 25 } };
    }
}
__decorate([
